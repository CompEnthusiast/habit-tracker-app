...
export default function Register() {
  ...
  return (
    <div
      ...
      style={{
        background: 'radial-gradient(ellipse at 70% 20%, rgba(168,85,247,0.15) 0%, transparent 50%), radial-gradient(ellipse at 30% 80%, rgba(99,102,241,0.12) 0%, transparent 50%), #12121c',
      }}
    >
